...
if __name__ == "__main__":
    ...
    for iter in range(max_iters):
        ...
        if iter % eval_interval == 0 or iter == max_iters - 1:
            ...
            # if validation loss is lower than previous best, save the model
            if iter == 0 or losses['val'] < best_val_loss:
                ...
                torch.save({
                    ...
                    'stoi': stoi,
                    'itos': itos
                }, 'gpt_model_least_val_loss.pth')

                print("Model saved as 'gpt_model_least_val_loss.pth'")
